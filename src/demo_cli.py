...
from src.core.utils import imread_safe, imwrite_safe
...
def main():
    ...
    img = imread_safe(args.image_path)
    if img is None:
    ...
    if imwrite_safe(args.output, result_img):
        print(f"Result saved to {args.output}")
    else:
        print(f"Error: Failed to save result to {args.output}")
